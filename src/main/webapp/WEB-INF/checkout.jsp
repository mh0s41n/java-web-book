    ...
    <div class="row">
        <table class="table table-hover">
            ...
            <c:forEach var="cartItem" items="${cart.cartItems}">
                <tr>
                    <td>
                        <b><c:out value="${cartItem.product.name}"/></b><br>
                    ...
                    <td>
                        <a class="btn btn-outline-warning" onclick="doAction(${cartItem.product.getId()}, 'delete')">
                            Remove
                        </a>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <a href="<c:url value="/home"/>" class="btn btn-outline-info text-left">Continue shopping</a>
                </td>
                <td>
